...
STRATEGIES = {
    ...
    "r1_v13_def": "trader-logic/round-1/r1_v13_defensive.py",
...
def main():
    ...
    paired_delta("r1_v12_def", "r1_v13_def", "v12", "v13")
    paired_delta("r1_v12_def", "r1_v14_def", "v12", "v14")
    paired_delta("r1_v13_def", "r1_v14_def", "v13", "v14")
