# R4 Manual — 4-Phase MC Verification Synthesis

**Compute spent**: 233,284 candidates * 50M paths (Phase 1) + top 100 * 1B paths * 5 seeds (Phase 2) + top 20 * sigma/KO/jump grids (Phase 3) + top 10 * 100M antithetic paths (Phase 4) = ~30 trillion strategy-paths total.
...
## Phase 2 Pareto frontier (mean / Sharpe / CVaR-5%)

11-point frontier on 1B-path 5-seed verification:

| # | Mean | Sharpe | CVaR-5% | Positions added to base |
|---|---:|---:|---:|---|
| 1 | $163,215 | 0.474 | -$552,743 | base DROP_60C |
| 2 | $162,358 | 0.496 | -$526,604 | +25 AC_45_P |
| 3 | $162,119 | 0.511 | -$473,625 | +15 AC_50_C |
...
| 7 | $159,674 | 0.605 | -$357,680 | **+25 AC_50_C +50 AC_45_P** ★ |
| 8 | $158,782 | 0.603 | -$357,460 | +25 AC_50_P +25 AC_50_C +25 AC_45_P |

Base = DROP_60C: { AC_50_P_2=+50, AC_50_C_2=+50, AC_50_CO=-50, AC_40_BP=-50, AC_45_KO=+500 }

## DOM_NICE_v2 (current recommendation) is DOMINATED

DOM_NICE_v2 = DROP_60C + 50 AC_35_P:
- Mean $161,099, Sharpe 0.494, CVaR-5% -$526,251 (Phase 2 rank #11)

Frontier point #3 (DROP+15 AC_50_C) **strictly dominates** DOM_NICE_v2:
- Mean $162,119 (+$1,020), Sharpe 0.511 (+0.017), CVaR-5% -$473,625 (+$52,626)

Better on all 3 dimensions.
